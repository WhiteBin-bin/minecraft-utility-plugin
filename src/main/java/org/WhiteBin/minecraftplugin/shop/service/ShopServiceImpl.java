...
public class ShopServiceImpl implements ShopService {
    ...
    public ShopItemInfo addItem(String shopName, ItemStack itemStack, BigDecimal price) {
        ...
        if (shopInfo == null || price.compareTo(BigDecimal.ZERO) <= 0) {
            return null;
        }
        ...
        ShopItemInfo itemInfo = new ShopItemInfo(slot, normalizeItemStack(itemStack), price);
    ...
    public ShopItemInfo setItem(String shopName, int slot, ItemStack itemStack, BigDecimal unitPrice) {
        ...
        ShopItemInfo itemInfo = new ShopItemInfo(slot, normalizeItemStack(itemStack), unitPrice);
        shopRepository.saveItem(shopName, itemInfo);
        return itemInfo;
    }
    ...
    public ShopPurchaseResult purchase(Player player, String shopName, int slot, int quantity) {
        ...
        BigDecimal totalPrice = itemInfo.price().multiply(BigDecimal.valueOf(quantity));
