...
import org.WhiteBin.minecraftplugin.shop.service.ShopTransactionLogServiceImpl;
...
public final class minecraftPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        ShopTransactionLogRepository shopTransactionLogRepository = new ShopTransactionLogRepository(this);
        ShopTransactionLogService shopTransactionLogService = new ShopTransactionLogServiceImpl(shopTransactionLogRepository);
        ShopService shopService = new ShopServiceImpl(shopRepository, economyService, shopTransactionLogService);
        ...
        ShopCommand shopCommandExecutor = new ShopCommand(shopService, shopTransactionLogService);
